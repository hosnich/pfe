        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                     ...
                     <form method="POST" action="{{ action('AjoutFormation@create') }}"> 
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="duree" type="string" class="form-control @error('duree') is-invalid @enderror" name="duree" value="{{ old('duree') }}" required autocomplete="duree" autofocus>
